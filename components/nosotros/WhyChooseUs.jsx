...
// ── Los 5 valores EXACTOS del PDF oficial de TIVO ──
const valores = [
  {
    numero: "01",
    titulo: "Confianza",
    descripcion:
      "Transparencia y responsabilidad en cada viaje. Construimos relaciones basadas en la honestidad entre usuarios y conductores.",
    // Ícono: apretón de manos
  ...
  },
  {
    ...
    titulo: "Seguridad",
    descripcion:
      "Procesos rigurosos de verificación para conductores y usuarios. Tu tranquilidad es parte esencial del viaje.",
    // Ícono: escudo con check
  ...
  },
  {
    ...
    titulo: "Innovación",
    descripcion:
      "Mejora constante del servicio y la tecnología. Evolucionamos para ofrecer una experiencia de movilidad cada vez mejor.",
    // Ícono: rayo / energía
  ...
  },
  {
    ...
    titulo: "Comunidad",
    descripcion:
      "Fomentamos una movilidad compartida basada en el respeto. Más que un viaje: construimos conexiones humanas reales.",
    // Ícono: personas conectadas
  ...
  },
  {
    ...
    descripcion:
      "Ofrecemos opciones de transporte más económicas. Compartir el viaje significa ahorrar y mover la ciudad de otra forma.",
    // Ícono: globo / mundo
...
export default function NuestrosValores() {
  ...
  return (
    <section className="py-16 lg:py-24 px-6 lg:px-10 bg-[#f5fbfe] relative overflow-hidden">
      ...
      {/* Patrón de líneas onduladas muy sutiles */}
        ...
        <div ref={headerRef} className="flex flex-col items-center text-center gap-4">
          ...
          >
            ...
            <span className="relative inline-block">
              <span className="relative z-10 text-[#0e4a6b]">valores</span>
              <motion.span
          ...
          >
            Los cinco principios que guían cada viaje, cada conexión y cada interacción dentro de la comunidad TIVO.
          </motion.p>
        </div>

        {/* GRID DE VALORES (5 columnas en desktop, responsive abajo) */}
        <motion.div
          ref={ref}
