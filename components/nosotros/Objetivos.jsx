    ...
    <section ref={ref} className="py-16 lg:py-24 px-6 lg:px-10 bg-white overflow-hidden relative">
      ...
      <div className="relative max-w-7xl mx-auto flex flex-col gap-12">
        ...
        <div className="flex flex-col items-center text-center gap-4">
          ...
          >
            Nuestros{" "}
            <span className="text-[#0e4a6b] italic">objetivos</span>
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <h3
              className="text-xl md:text-2xl font-bold text-[#0e2a3d] leading-snug"
              style={{ fontFamily: "Georgia, serif" }}
            >
              Posicionarnos en el mercado limeño
            </h3>

            <p className="text-[#4a6170] text-sm md:text-base leading-relaxed">
              En el corto plazo buscamos posicionarnos como la marca TIVO en el mercado limeño como
              una plataforma de movilidad compartida, además de captar usuarios y conductores
              registrados en la aplicación y generar reconocimiento de marca a través de redes sociales.
            </p>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-[#4a6170] font-medium">Meta inmediata</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <h3
              className="relative text-xl md:text-2xl font-bold text-white leading-snug"
              style={{ fontFamily: "Georgia, serif" }}
            >
              Expandirnos a más ciudades del Perú
            </h3>

            <p className="relative text-white/75 text-sm md:text-base leading-relaxed">
              A largo plazo buscamos consolidar a TIVO como una alternativa competitiva frente a otras
              aplicaciones de movilidad, expandiendo el servicio a más distritos y ciudades del Perú, e
              incrementando progresivamente la base de usuarios activos y conductores afiliados a la plataforma.
            </p>
            ...
            <div className="relative flex items-center gap-2">
              ...
              <span className="text-xs text-white/60 font-medium">Visión a futuro</span>
            </div>
          </motion.div>
        </div>
      </div>
