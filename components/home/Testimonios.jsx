...
export default function Testimonios() {
  ...
  useEffect(() => {
    setTestimonios(tT.mock);
    setLoading(false);
    setActual(0); // resetear al cambiar de idioma
  }, [tT]);
          ...
          <div className="relative">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className="text-lg md:text-xl text-[#0e2a3d] leading-relaxed mb-8 relative italic" style={{ fontFamily: "Georgia, serif" }}>
                ...
                <div className="flex items-center gap-4">
                  {testimonios[actual].foto ? (
                    ...
                    <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#0e4a6b] to-[#1bb5e0] flex items-center justify-center text-white font-bold text-lg" style={{ fontFamily: "Georgia, serif" }}>
