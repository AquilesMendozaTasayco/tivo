...
const ICONOS = [TrafficCone, Leaf, Users2];

export default function Impacto() {
  const { t } = useLang();
  const tImp = t.impacto;
                    ...
                    <div className="flex items-start gap-5 bg-white/5 backdrop-blur-sm rounded-2xl p-5 md:p-6 border border-white/10 hover:border-[#4ac8e8]/40 hover:bg-white/10 transition-all duration-300">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-baseline gap-3 mb-1 flex-wrap">
                          <p className="text-3xl md:text-4xl font-bold text-white leading-none" style={{ fontFamily: "Georgia, serif" }}>
                            {s.numero}
                          </p>
                          <h3 className="text-base md:text-lg font-bold text-[#7fdcf2]" style={{ fontFamily: "Georgia, serif" }}>
                            {s.titulo}
                          </h3>
                        </div>
